        ...
        <div class="wrap-login">
            <form class="login-form validate-form" action="{{ route('login') }}" method="POST">
                ...
                <span class="login-form-title">
                    <a class="nav-link" href="{{ route('login') }}">{{ __('Login Form') }}</a>
                </span>
                ...
                <div class="container-login-form-btn">
                    <div class="wrap-login-form-btn">
                        <button class="login-form-btn"> Login Now </button>
                    </div>
                </div>
                <div class="text-center">
                    ...
                    <a class="nav-link txt2" href="{{ route('register') }}">{{ __('Register now') }}</a>
                    @endif
                </div>
            </form>
        </div>
