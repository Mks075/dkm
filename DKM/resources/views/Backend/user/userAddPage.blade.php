                ...
                <div class="row g-3">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="col-8">
                                    <form action="{{ route('user.store')}}" id="formValidate" method="POST"
                                        class="alert alert-primary p-3 mb-0 w-100">
                                        @csrf
                                        {{-- {{ csrf_field() }} --}}
                                        <div class="m-3">
                                            <label for="name" class="form-label">Min. 6 Characters</label>
                                            <input type="text" class="form-control form-control-lg"
                                                placeholder="Enter Username" name="name" id="name"
                                        ...
                                        <div class="m-3">
                                            ...
                                            <input type="email" class="form-control form-control-lg"
                                                placeholder="Enter E-mail Address" name="email"
                                                data-parsley-range="[8,30]" id="email">
                                            <span class="error">{{ ($errors->has('email'))?($errors->first('email')):""}}</span>
                                        </div>
                                        <div class="m-3">
                                            <label for="Pass1" class="form-label">Min 6 Characters</label>
                                            <input type="password" class="form-control form-control-lg"
                                                placeholder="Enter Password" name="Pass1" id="Pass1">
                                            <span class="error">{{ ($errors->has('Pass1'))?($errors->first('Pass1')):""}}</span>
                                        </div>
                                        <div class="m-3">
                                            <label for="text-input4" class="form-label">Must Match Entired password</label>
                                            <input type="password" class="form-control form-control-lg"
                                                placeholder="Confirm Password" name="Pass2" id="text-input4">
                                        </div>
                                        <div class="m-3">
                                            <label for="userType" class="form-label">Select Your Roll</label>
                                            <select class="form-control-lg form-select" name="userType"
                                                id="userType">
                                                <option value="Admin">Admin</option>
                                                <option value="DB Manager">DB Manager</option>
                                                <option value="Normal User">Normal User</option>
                                            </select>
                                            <span class="error">{{ ($errors->has('userType'))?($errors->first('userType')):""}}</span>
                                        </div>
                                        <div class="mx-3">
